...
For more details and further functionality, please refer to the [usage documentation](https://nf-co.re/fastqfetcher/usage) and the [parameter documentation](https://nf-co.re/fastqfetcher/parameters).

## Pipeline output

To see the results of an example test run with a full size dataset refer to the [results](https://nf-co.re/fastqfetcher/results) tab on the nf-core website pipeline page.
For more details about the output files and reports, please refer to the
[output documentation](https://nf-co.re/fastqfetcher/output).
...
For further information or help, don't hesitate to get in touch on the [Slack `#fastqfetcher` channel](https://nfcore.slack.com/channels/fastqfetcher) (you can join with [this invite](https://nf-co.re/join/slack)).
